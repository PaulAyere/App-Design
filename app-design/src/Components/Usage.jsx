...
const Usage = () => {
  return (
    <div id="usage" className="p-4">
      <h1 className="text-6xl font-bold uppercase text-pink-500 mb-8 text-center">How it works</h1>
      <div className="flex flex-col md:flex-row mt-8">
        <div className="w-full md:w-1/2 flex flex-col mr-0 justify-end items-end">
          <div className="flex flex-col items-end mb-4">
            <i className="fas fa-sort-amount-down text-6xl mb-6 text-rose-700"></i>
          ...
          <div className="flex flex-col items-end">
            <i className="fas fa-user-clock text-6xl mb-6 text-rose-700"></i>
        ...
        <div className="w-full md:w-1/2 flex flex-col ml-0 justify-start">
          <div className="flex flex-col items-start mb-4">
            <i className="fas fa-sort-amount-up text-6xl mb-6 text-rose-700"></i>
          ...
          <div className="flex flex-col items-start">
            <i className="fas fa-fire text-6xl mb-6 text-rose-700"></i>
